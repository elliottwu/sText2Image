...
with tf.Session(config=config) as sess:
    dcgan = DCGAN(sess, image_size=args.imgSize, batch_size=args.batchSize, text_vector_dim=args.text_vector_dim,
                  checkpoint_dir=args.checkpointDir, lam=args.lam, lam2=args.lam2)
    dcgan.complete(args)
